        ...
        <div>
            <footer className="footer xl:px-24 py-10 px-4  text-base-content">
                ...
                <nav>
                    ...
                    <a className="link link-hover">+64 527 436 966</a>
                    <a className="link link-hover">Social Media</a>
                    <a className="link link-hover">CatalFlow Dubai</a>
                </nav>
            </footer>
            <hr />
            <footer className="footer items-center xl:px-24 py-10 px-4 ">

                <nav className="grid-flow-col -gap-4 md:place-self-start md:justify-self-start gap-7">
                ...
                <aside className="items-center grid-flow-col">
                    <p>Copyright © 2024 Decode | All right reserved</p>
                </aside>
